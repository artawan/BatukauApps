    ...
    return (
      <ScrollView style={styles.container}>
        ...
        <View style={styles.upakaraContainer}>
          ...
          <Image style={styles.image} source={require('./assets/upakara_210_1.jpg')}/>
          <Image style={styles.image} source={require('./assets/upakara_210_2.jpg')}/>
          <Image style={styles.image} source={require('./assets/upakara_210_3.jpg')}/>
