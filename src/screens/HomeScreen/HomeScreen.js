...
const HomeScreen = (props) => {
  ...
  const [contentOpened, setContentOpened] = React.useState(false);
  const [sliderItem] = React.useState(sliderItemState)
    ...
    <View style={styles.container}>
      ...
      <View
        style={[
          ...
          contentOpened ? styles.contentOpened : null,
        ]}
      >
        <TouchableOpacity
          style={styles.openButton}
          onPress={() => setContentOpened(!contentOpened)}
        >
